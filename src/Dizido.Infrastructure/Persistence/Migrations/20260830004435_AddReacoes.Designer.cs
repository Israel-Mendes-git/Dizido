...
namespace Dizido.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260830004435_AddReacoes")]
    partial class AddReacoes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Dizido.Domain.Entities.Attachment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Dizido.Domain.Entities.Decision", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Dizido.Domain.Entities.Message", b =>
                {
                    ...
                    b.Property<Guid?>("SystemTargetId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Dizido.Domain.Entities.Reaction", b =>
                {
                    b.Property<Guid>("MessageId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Dizido.Domain.Entities.Message", b =>
                {
                    b.HasOne("Dizido.Domain.Entities.Attachment", null)
                        .WithMany()
